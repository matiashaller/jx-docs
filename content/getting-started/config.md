...
Once you have installed you can make more changes via [jx upgrade platform --always-upgrade](https://jenkins-x.io/commands/jx_upgrade_platform/) which will reuse your `myvalues.yaml` file.
